...
int main (int argc, char** argv)
{
  ...
  print_info ("Clean out outliers in point cloud data and execute surface reconstruction on a PCD file, then export the file in PLY format. For more information, use: %s -h\n", argv[0]);
  ...
  // Save output as PLY
  pcl::io::savePLYFileBinary (argv[ply_file_indices[0]], mls_points);
}